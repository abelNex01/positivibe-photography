...
export const Philosophy = (): JSX.Element => {
  return (
    <section className="w-full bg-[#0a0a0a] text-white py-24 md:py-32 lg:py-40 px-6 sm:px-12 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-[1000px] w-full flex flex-col items-center text-center z-10">
        ...
        >
          We don't just capture moments, we <br className="hidden md:block" />
        ...
        >
          Our approach to photography is rooted in high-end editorial
          storytelling. We believe that true luxury lies in the unseen details
          the quiet tension before the vow, the intentional fall of silk, and
          the raw emotion of a stolen glance. Every session is treated as a
          bespoke commission, crafted to reflect the authentic grandeur of your
          story.
        </motion.p>
